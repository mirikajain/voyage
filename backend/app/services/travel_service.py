        ...
        if "goa" in dest_lower:
            ...
            return [
                ...
                FlightOption(
                    ...
                    provider="IndiGo Premier",
                    airline="IndiGo 6E 614",
                    flight_number="6E 614",
                    origin=f"{origin} ({orig_iata})",
                    destination="Goa (GOX)",
                    ...
                    total_price=8400.0,
                    currency="INR",
                    source="Voyage Provider Network",
                    is_live=False
                ),
                FlightOption(
                    id="flt-akasa-goa-003",
                    provider="Akasa Air Direct",
                    airline="Akasa Air (QP-1382)",
